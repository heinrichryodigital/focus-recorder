...
export default function Download() {
  return <><Header/><main id="main" className="content-page page-width">
    ...
    <div className="content-grid">
      <article className="info-card"><ApplePlatformIcon size={32}/><h2>Focus for macOS</h2><span className="status-pill">Free preview · v0.3.0</span>
      ...
      <article className="info-card"><WindowsPlatformIcon size={32}/><h2>Focus for Windows</h2><span className="status-pill pending">Free preview · v0.3.0</span>
