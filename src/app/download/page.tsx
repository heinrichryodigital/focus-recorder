...
const release = 'https://github.com/heinrichryodigital/focus-recorder/releases/download/v0.5.0-firebase-preview';
export default function Download() {
  return <><Header/><main id="main" className="content-page page-width">
    ...
    <div className="content-grid">
      <article className="info-card"><ApplePlatformIcon size={32}/><h2>Focus for macOS</h2><span className="status-pill">Free preview · v0.5.0</span>
        ...
        <a className="button button-dark" href={release + '/Focus-Recorder-0.5.0-macOS-arm64.zip'}><DownloadIcon size={17}/> Download free for Mac</a>
      ...
      <article className="info-card"><WindowsPlatformIcon size={32}/><h2>Focus for Windows</h2><span className="status-pill pending">Free preview · v0.5.0</span>
        ...
        <a className="button button-dark" href={release + '/Focus-Recorder-0.5.0-Windows-x64.exe'}><DownloadIcon size={17}/> Download free for Windows</a>
